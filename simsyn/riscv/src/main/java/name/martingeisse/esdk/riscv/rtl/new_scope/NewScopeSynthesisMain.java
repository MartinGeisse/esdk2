...
import name.martingeisse.esdk.riscv.rtl.ComputerDesign;
import name.martingeisse.esdk.riscv.rtl.ComputerModule;
...
public class NewScopeSynthesisMain {
	...
	public static void main(String[] args) throws Exception {
		...
		ComputerDesign design = new ComputerDesign("riscv/resource/new-scope-program/build/program.bin") {
			@Override
