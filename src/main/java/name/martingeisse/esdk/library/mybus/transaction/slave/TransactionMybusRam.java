package name.martingeisse.esdk.library.mybus.transaction.slave;

import name.martingeisse.esdk.core.model.Design;
import name.martingeisse.esdk.core.model.Item;
import name.martingeisse.esdk.library.mybus.transaction.TransactionMybusSlave;

/**
 * A simple on-chip memory that uses the lowest N address bits to store 2^N 32-bit words.
 */
public final class TransactionMybusRam extends Item implements TransactionMybusSlave {
	...
	public TransactionMybusRam(Design design, int addressBits) {
		super(design);
