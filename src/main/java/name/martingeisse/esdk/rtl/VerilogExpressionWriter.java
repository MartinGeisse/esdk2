 ...
 *
 * Signal classes should use {@link #print(RtlSignal)} or
 * {@link #print(RtlSignal, VerilogDesignGenerator.VerilogExpressionNesting)} to print sub-expressions. Directly calling
 * {@link RtlSignal#printVerilogExpression(VerilogExpressionWriter)} will prevent the sub-expression from being
 * extracted for shared signals or invalid nesting. In some cases, this can even generate Verilog with wrong semantics.
 */
