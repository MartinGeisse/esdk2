 ...
 * TODO
 */
public final class RtlFramebufferDisplay extends RtlClockedItem implements FramebufferDisplay {
	...
	public RtlFramebufferDisplay(RtlClockNetwork clockNetwork, BufferedImage framebuffer, int widthBits) {
		super(clockNetwork);
