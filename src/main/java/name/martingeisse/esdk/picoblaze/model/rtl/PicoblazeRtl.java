...
public class PicoblazeRtl extends RtlClockedItem {
	...
	public PicoblazeRtl(RtlClockNetwork clockNetwork) {
		...
		instructionAddressPort.setSimulationSignal(RtlSimulatedComputedVectorSignal.ofUnsigned(getRealm(), 10, state::getPc));
		...
		portIdPort.setSimulationSignal(RtlSimulatedComputedVectorSignal.ofUnsigned(getRealm(), 8, state::getPortAddress));
		...
		dataOutputPort.setSimulationSignal(RtlSimulatedComputedVectorSignal.ofUnsigned(getRealm(), 8, state::getPortOutputData));
