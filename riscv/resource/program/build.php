...
system('riscv32-unknown-elf-ld -Map=build/output.map -A rv32im -N -Ttext 0 -o build/program.elf -e 0 build/start.o build/main.o build/terminal.o build/system.o');
