...
system('riscv32-unknown-elf-gcc -march=rv32im -c -o build/display_test.o src/display_test.S');
system('riscv32-unknown-elf-gcc -march=rv32im -c -o build/hello.o src/hello.S');
