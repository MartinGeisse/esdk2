...
system('riscv32-unknown-elf-gcc -msmall-data-limit=100000 -march=rv32im -mabi=ilp32 -c -o build/vec3test.o src/vec3test.cpp');
system('riscv32-unknown-elf-gcc -msmall-data-limit=100000 -march=rv32im -mabi=ilp32 -c -o build/engine.o src/engine.cpp');
system('riscv32-unknown-elf-ld -Map=build/program.map -A rv32im -N -Ttext 0 -o build/program.elf -e 0 build/start.o build/main.o build/system.o build/draw.o build/simdev.o build/cpu.o');
