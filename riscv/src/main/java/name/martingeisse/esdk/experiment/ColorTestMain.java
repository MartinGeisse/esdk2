...
public class ColorTestMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        vgaColorPin(realm, "H14",  highspeedClk180, colorTest.getR(), highspeedClk0, colorTest.getR());
        vgaColorPin(realm, "H15",  highspeedClk180, colorTest.getG(), highspeedClk0, colorTest.getG());
        vgaColorPin(realm, "G15",  highspeedClk180, colorTest.getB(), highspeedClk0, colorTest.getB());
